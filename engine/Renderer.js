        ...
        get displayObjects() {
            return _getDisplayObjects(this.stage)
                ...
                function _getDisplayObjects(container, result = []){
                    for(const displayObjects of container.displayObjects){
                        if(displayObjects instanceof GameEngine.Container){
                            _getDisplayObjects(displayObjects, result)
                    }else{
                        result.push(displayObjects)
                    }
                }
                return result
            }
